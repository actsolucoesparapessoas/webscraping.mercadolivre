...
sidebar_MKD(info, alinhamento = "centralizado", tamanho_fonte = 18, cor_fonte = '#4682B4')
st.sidebar.write('')
...
with tab1:
    ...
    with st.form("Formulário"):
        ...
        with col2:
            ...
            Passo2 = '<p style="font-weight: bolder; color:#4682B4; font-size: 18px">Cadastrar na Lista de Compras</p>'
